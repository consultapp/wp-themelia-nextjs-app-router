...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 744)), "/Users/dmitry/Projects/Next/wp-themelia-nextjs-app-router/src/app/(posts)/post/[slug]/page.jsx"],
...
'not-found': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 8276)), "/Users/dmitry/Projects/Next/wp-themelia-nextjs-app-router/src/app/not-found.jsx"],
    ...
    const pages = ["/Users/dmitry/Projects/Next/wp-themelia-nextjs-app-router/src/app/(posts)/post/[slug]/page.jsx"];
    ...
    const originalPathname = "/(posts)/post/[slug]/page"
...
;// CONCATENATED MODULE: ./src/components/Post/Post.jsx
...
function Post({ post  }) {
    if (!post || !post.length) return (0,navigation.redirect)("/404");
    const { id , content , slug , title , date  } = post[0];
    const contentRendered = (0,functions/* trimLinkReadNext */.vC)(content?.rendered || "");
...
;// CONCATENATED MODULE: ./src/app/(posts)/post/[slug]/page.jsx



async function PostPage({ params  }) {
    const { slug  } = params;
    const post = await (0,functions/* getPostsBySlug */.Hr)(slug);
...
var __webpack_exports__ = __webpack_require__.X(0, [405,188,914,875,834,180,721], () => (__webpack_exec__(9827)));
